...
export const staffApi = {
  ...
  getUsers:       (params?: { hasAttendanceToday?: boolean }) => apiClient.get<ApiResponse<{ id: number; name: string; phone: string; role: string; generatedPin: string | null; isActive: boolean; designationName: string | null; completedTripsCount: number; isAssigned: boolean; activeOrderNumber: string | null; assignmentType: string | null; activeLeaseNumber: string | null }[]>>('/users', { params }).then(r => r.data),
