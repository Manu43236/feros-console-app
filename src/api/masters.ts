...
export const globalMastersApi = {
  ...
  getUnits:                     () => apiClient.get<ApiResponse<MasterItem[]>>('/masters/global/units').then(r => r.data),
  createUnit: (data: { name: string }) => apiClient.post<ApiResponse<MasterItem>>('/masters/global/units', data).then(r => r.data),
  updateUnit: (id: number, data: { name: string }) => apiClient.put<ApiResponse<MasterItem>>(`/masters/global/units/${id}`, data).then(r => r.data),
  deleteUnit: (id: number) => apiClient.delete(`/masters/global/units/${id}`),
  ...
  deleteEquipmentServiceTaskType: (id: number) => apiClient.delete<ApiResponse<void>>('/masters/global/equipment-service-task-types/' + id).then(r => r.data),
