...
export interface DocumentTypeItem extends MasterItem { applicableFor: 'VEHICLE' | 'DRIVER' | 'BOTH' | 'EQUIPMENT'; applicableRoles: string[] | null; allowMultiple: boolean }
...
export interface StaffProfile {
  ...
  salaryType?: 'DAILY' | 'MONTHLY'; monthlySalary?: number; allowedOffDays?: number; skipCalendar?: boolean
...
export interface Payroll {
  ...
  overtimeHours: number; salaryType?: 'DAILY' | 'MONTHLY'; dailyRate?: number; monthlySalary?: number; allowedOffDays?: number; skipCalendar?: boolean
