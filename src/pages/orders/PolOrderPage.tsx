...
export default function PolOrderPage() {
  ...
  // Attendance for the selected order date
  ...
  // Auto-fill destination from client
  useEffect(() => {
  ...
  const mutation = useMutation({
    mutationFn: (data: FormData) => {
      const payload: Record<string, unknown> = {
        ...
        freightRateType:    data.freightRateType,
            ...
            <div key={i} className="border border-gray-200 rounded-lg p-4 space-y-3 relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    value={row.paperLrNumber}
                    onChange={e => updateRow(i, 'paperLrNumber', e.target.value)}
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={e => updateRow(i, 'vehicleCapacity', Number(e.target.value))}
                    placeholder="20.00"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={e => updateRow(i, 'allocatedWeight', Number(e.target.value))}
                    placeholder="18.00"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={e => updateRow(i, 'loadedWeight', Number(e.target.value))}
                    placeholder="18.00"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    value={row.ewayBillNumber}
                    onChange={e => updateRow(i, 'ewayBillNumber', e.target.value)}
