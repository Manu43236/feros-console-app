...
import LeaseInvoicesPage         from '@/pages/vehicles/LeaseInvoicesPage'
...
import { ServiceInvoiceDetailPage } from '@/pages/invoices/ServiceInvoiceDetailPage'
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="service-invoices/:id" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN','ADMIN','OFFICE_STAFF']}><ServiceInvoiceDetailPage /></ProtectedRoute>} />
          ...
          <Route path="vehicles/lease-invoices"       element={<ProtectedRoute allowedRoles={['ADMIN','OFFICE_STAFF']}><LeaseInvoicesPage /></ProtectedRoute>} />
          ...
          <Route path="reports/payroll"   element={<ProtectedRoute allowedRoles={['SUPER_ADMIN','ADMIN','OFFICE_STAFF']}><PayrollReportsPage /></ProtectedRoute>} />
...
{/* SUPER_ADMIN */}
          ...
          <Route path="equipment/machines"              element={<ProtectedRoute allowedRoles={['ADMIN','OFFICE_STAFF','SUPERVISOR','SERVICE_MANAGER']}><EquipmentListPage /></ProtectedRoute>} />
          <Route path="equipment/machines/:equipmentId" element={<ProtectedRoute allowedRoles={['ADMIN','OFFICE_STAFF','SUPERVISOR','SERVICE_MANAGER']}><MachineDetailPage /></ProtectedRoute>} />
